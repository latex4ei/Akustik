...
\sectionbox{
	...
	$$f = \frac{c}{2π} \sqrt{\frac{S_{\ir Offnung}}{V_{\ir Bauch} \left(l_{\ir Hals} ⋅ \frac{π}{2} ⋅ r_{\ir Hals} \right)}}$$
}
...
\sectionbox{
    ...
    DIN, ISO, VDI-Richtlinien, ITG, DEGA, ASA
		...
		$P= I ⋅ S$, $L_W = 10 \log \frac{P_A}{P_0} dB$ \quad $P_0 = \SI{e-12}{W}$\\
		$P_A = 10^{\frac{90}{10}} \cdot \SI{e-12}{W} =\SI{e-3}{W}$\\
		In 10m Abstand?\\
		$S = 4πr^2 = 4 ⋅ π 100m^2 \approx 1200m^2$\\
